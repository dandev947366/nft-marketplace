...
const NFT = () => {
  ...
  return (
    <div className="">
      <div className="w-4/5 flex flex-col mt-11 mx-auto bg-white border border-gray-300 rounded-md shadow-md -z-10 dark:bg-gray-800 dark:border-gray-700 ">
      ...
      <div className="w-4/5 flex flex-col mt-11 mx-auto bg-white border border-gray-300 rounded-md shadow-md shadow-indigo-600 -z-10 dark:bg-gray-800 dark:border-gray-700 ">
        <div className={openBox ? "opacity-50" : "opacity-100"}>
          <div className="relative my-4 mx-4 md:flex-row w-full justify-between items-center mx-auto">
