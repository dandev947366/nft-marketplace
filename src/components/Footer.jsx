...
const Footer = () => {
  return (
    <div className="">
      <div className="pt-8 mt-20 mx-auto bg-white border-t-2 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 shadow-[0px_-50px_100px_-49px_rgba(34,_197,_94,_0.5)]">
