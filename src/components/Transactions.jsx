...
const Transactions = () => {
  ...
  return (
    <div className="w-full mb-10 flex bg-gray-800 border border-gray-700 rounded-md shadow-md -z-10 dark:bg-gray-800 dark:border-gray-700 shadow-[0px_0px_100px_-21px_rgba(147,_51,_234,_0.5)]">
      <div className="w-4/5 py-10 mx-auto">
        <h4 className="text-white text-3xl font-bold uppercase text-gradient">
          ...
          {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-4 lg:gap-2 py-2.5">
            <div className="flex justify-between items-center border border-gray-600 text-gray-400 w-full rounded-md overflow-hidden bg-gray-800 my-2 p-3"
            >
              <div className="rounded-md shadow-sm shadow-indigo-600 p-2">
                <BiTransfer />
              </div>

              <div>
                <h4 className="text-sm">Nft 1 Transfered</h4>
                <small className="flex flex-row justify-start items-center">
                  <span className="mr-1">Received by</span>
                  <a href="#" className="text-indigo-500 mr-2">
                   0x123....
                  </a>
                  <a href="#">
                    <MdOpenInNew />
              ...
              <p className="text-sm font-medium">0.02 ETH</p>
            </div>
        </div> */}
