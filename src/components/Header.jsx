...
const Header = () => {
  ...
  return (
    <>
      <nav className="inset-x-0 top-0 w-full bg-gray-800 border border-gray-700 border-b md:px-2 dark:border-gray-500/50 dark:bg-gray-800 py-2.5 shadow-lg z-50">
      ...
      <div className="flex items-center gap-1 px-12 py-1 text-sm text-gray-600 rounded bg-gray-800 dark:bg-gray-700/50 dark:text-gray-300 mx-auto ml-auto">
        {/* Display network name */}
        {chainId && (
          <div className="">
            <span className="">Network: {getNetworkName(chainId)}</span>
            <span className="p-3">Balance: {balance} ETH</span>
          </div>
        )}
      </div>
    </>
